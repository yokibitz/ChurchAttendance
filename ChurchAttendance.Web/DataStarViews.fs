        ...
        Fragment() {
            yield! enrichedAttendees |> List.map (fun attendee ->
                tr(class'="odd:bg-gray-100 even:bg-white") { 
                    ...
                    td(class'="py-2 px-4 border-b") { $"{attendee.LastName} {attendee.FirstName}" }
                ...
                main() {
                    div(class'="container mx-auto") {
                        div(class'="flex space-x-4 my-4") {
                            nav() {
                                a(class'="tab-link", hxGet="/attendance/sheet/12/2024/children", hxTarget=".tabcontent") { 
                                    "Children" 
                                }
                            }
                            nav() {
                            ...
                            input(type'="month", class'="ml-auto")
                            select() { 
                                option( value="Infants") { "Infants"} 
                                option(value="Children") { "Children"} 
                                option(value="CYN") { "CYN"} 
                                option(value="YAN") { "YAN"} 
